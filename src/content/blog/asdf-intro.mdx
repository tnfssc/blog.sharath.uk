...
For all the lazy readers 🤓 out there, [click here](#theImportantBit) to skip ahead to the important bit on how to use the thing. I highly recommend NOT skipping for first time readers.
...
#### Clone the repo <Github class="h-4 w-4 inline ml-1" />
